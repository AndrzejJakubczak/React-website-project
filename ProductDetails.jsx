    ...
    return ( 
        <Fragment>
                    ...
                    <Row className="justify-content-center">
                        ...
                        <Col md={6}>
                            ...
                            <div className="rate">
                                ...
                                <span>Ocena: {selectedProduct?.avgRating}</span>
                            </div>
                            <div className="info">
                                <span className="price">{selectedProduct?.price} zł</span>
                                <span>Kategoria: {selectedProduct?.category}</span>
                            </div>
                            <p>{selectedProduct?.shortDesc}</p>
                            <input className="qty-input" type="number" placeholder="Qty" value={quantity} onChange={handleQuantityChange} />
                            <button aria-label="Add" type="submit" className="add" onClick={() => handelAdd(selectedProduct,quantity)}>Dodaj do koszyka</button>
                        </Col>
                    </Row>
                </Container>
            </section>
                ...
                <Container>
                    <ul>
                        ...
                        <li style={{color:listSelected ==="rev"?"black":"#9c9b9b"}} onClick={()=> setListSelected("rev")}>
                            Opinie ({selectedProduct?.reviews.length})
                        </li>
                    </ul>
                    {listSelected ==="desc"?
            ...
            <section className="related-products">
                <Container>
                    <h3>Innym użytkownikom spodobało się również:</h3>
                </Container>
